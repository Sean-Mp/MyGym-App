...
const {UserDatabase, WorkoutDatabase, ExerciseDatabase, NutritionDatabase} = require('../db_connection');
...
//     try{
//         const r1 = await conn.createWorkout("My Workout", 3);
//         console.log(r1);

//         const r2 = await conn.getWorkout(3);
//         console.log(r2);

//         const r3 = await conn.updateDate(new Date(), 5);
//         console.log(r3);
